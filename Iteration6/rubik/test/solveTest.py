...
#        test030: Valid cube with two diagonal corners solved
    ...
    def test1070_020ValidCubeWithTwoAdjacentCornersSolved(self):
        ...
        expectedResult = {}
        expectedResult['rotations'] = 'URUrURUUruRUrURUUrURUrURUUr'
        expectedResult['cube'] = 'brgrrrrrrobrggggggggbooooooroobbbbbbyyyyyyyyywwwwwwwww'
        actualResult = solve._solveUpFace(inputDict)
        self.assertDictEqual(expectedResult, actualResult)
    ...
    def test1070_030ValidCubeWithTwoDiagonalCornersSolved(self):
        ...
        expectedResult = {}
        expectedResult['rotations'] = 'UURUrURUUrRUrURUUrRUrURUUr'
        expectedResult['cube'] = 'ororrrrrrbobggggggrbroooooogggbbbbbbyyyyyyyyywwwwwwwww'
        actualResult = solve._solveUpFace(inputDict)
        self.assertDictEqual(expectedResult, actualResult)
     
# 1080 _solveUpCorners
#    inputs: 
#        parms:    dict; mandatory; arrives validated
#        parms['cube']:    string; len=54; [brgoyw]; 9 occurrences of each character, unique middle character; mandatory; arrives validated
#    outputs:
...
#        returns:    dict
#        nominal: 
#            dict['rotations']: string, valid rotations to solve up corners of cube
#            dict['cube']: string, valid cube after rotations for up corners are performed
#        abnormal: 
#            no abnormal behavior since method is only called if down and middle layer are solved and top face is solved; cube is already validated
#    confidence level: boundary value analysis
#
#    happy path:  
#        test010: Valid cube with no matching adjacent corners
#        test020: Valid cube with solved up corners
        
    def test1080_010ValidCubeWithNoMatchingAdjacentCorners(self):
        inputDict = {}
        inputDict['cube'] = 'bogbbbbbborrrrrrrrggbggggggrboooooooyyyyyyyyywwwwwwwww'
        expectedResult = {}
        expectedResult['rotations'] = 'lURuLUUrURUUrubUFuBUUfUFUUf'
        expectedResult['cube'] = 'bgbbbbbbbrrrrrrrrrgogggggggoboooooooyyyyyyyyywwwwwwwww'
        actualResult = solve._solveUpCorners(inputDict)
        self.assertDictEqual(expectedResult, actualResult)
        
    def test1080_020ValidCubeWithSolvedUpCorners(self):
        inputDict = {}
...
#        returns:    dict
#        nominal: 
#            dict['rotations']: string, valid rotations to solve up middle pieces of cube
#            dict['cube']: string, valid cube after rotations for up middle pieces are performed
#        abnormal: 
#            no abnormal behavior since method is only called if down and middle layer are solved and top face and corners are solved; cube is already validated
#    confidence level: boundary value analysis
#
#    happy path:  
#        test010: Valid cube with no complete side face
#        test020: Valid solved cube
    
    def test1090_010ValidCubeWithNoCompleteSideFace(self):
        inputDict = {}
        inputDict['cube'] = 'bobbbbbbbrgrrrrrrrgrgggggggoboooooooyyyyyyyyywwwwwwwww'
        expectedResult = {}
        expectedResult['rotations'] = 'FFUrLFFlRUFFRRUbFRRfBURR'
        expectedResult['cube'] = 'bbbbbbbbbrrrrrrrrrgggggggggoooooooooyyyyyyyyywwwwwwwww'
        actualResult = solve._solveUpMiddlePieces(inputDict)
        self.assertDictEqual(expectedResult, actualResult)
        
    def test1090_020ValidCubeSolvedCube(self):
        inputDict = {}
